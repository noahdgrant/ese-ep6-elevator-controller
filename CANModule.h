...
#define FLOOR1_SP 300                       // Floor 1 setpoint from bottom (sensor)
#define FLOOR2_SP 800                       // Floor 2 setpoint from bottom (sensor)
#define FLOOR3_SP 1200                      // Floor 3 setpoint from bottom (sensor)
#define SETPOINT_TOLERANCE 20               // in mm
...
#define MASK 0x07FF0000                    // Mask for filters
